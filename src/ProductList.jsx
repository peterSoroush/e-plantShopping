...
function ProductList({ onHomeClick }) {
  ...
  // Get the list of items from Redux
  const cartItems = useSelector((state) => state.cart.items);
  const dispatch = useDispatch();

  // Calculate total quantity for the badge logic
            ...
            <div key={index}>
              ...
              <div className="product-list">
                {category.plants.map((plant, plantIndex) => {
                  // THIS IS THE FIX:
                  // Check if the plant exists in the cartItems array from Redux
                  ...
                  return (
                    <div className="product-card" key={plantIndex}>
                      ...
                      <button
                        ...
                        disabled={isAdded} // Disable based on global state
                      >
